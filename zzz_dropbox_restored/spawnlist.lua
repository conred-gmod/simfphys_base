...
local V = {
	...
	Members = {
		...
		ModelInfo = {
			...
			LinkDoorAnims = {
				["ENTERPOS_EXITPOS_ATTACHMENT_NAME"] = {
					enter = "ENTERING_ANIMATION_NAME",
					exit = "EXIT_ANIMATION_NAME",
				},
				["enter1"] = {
					enter = "enter2",
					exit = "exit2",
		...
		-- how LinkDoorAnims works:
		-- Once E is pressed the script will look wich of the attachments are closest to the player and then trigger its linked entering or exit animations.
		-- The camera/player will also follow the "vehicle_driver_eyes" attachment just like prop_vehicle_jeep vehicles.
		-- Note: Attachments are NOT the attached props (wich are defined down below). They are points defined in the model.
		]]--
		...
		--ForceTransmission = 1,  -- force a transmission type?  1 = Automatic,  2 = Manual
